...
start_time_list = []
end_time_list = []
event_list = [[] for _ in range(40)]  # Create a list containing 40 (total trials) empty lists
click_list = []
...
df.to_excel(f'C:/Users/{user}/Dropbox/Kerri_Walter/BexLabGenAI/{participant}_data.xlsx', sheet_name='sheet1', index=False)

#eyetracker data
with open(f'C:/Users/{user}/Dropbox/Kerri_Walter/BexLabGenAI/{participant}_gaze_data.json', 'w') as f:
