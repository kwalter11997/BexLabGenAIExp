# -*- coding: utf-8 -*-
"""
Created on Mon Jan 13 15:37:10 2025
...
directory = fr'C:\Users\{user}\Dropbox\Kerri_Walter\BexLabGenAI/5Levels'
...
expName = 'BexLab Gen AI Experiment (5Levels)'
expInfo = {'Participant':''}
...
os.makedirs(f'C:/Users/{user}/Dropbox/Kerri_Walter/generativeAI/5Levels/{expInfo["Participant"]}') #create a folder for this participants images
participant = expInfo['Participant']

### Run prompt generator ###
generate_prompts = subprocess.Popen(["python", f"C:\\Users\{user}\\Dropbox\\Kerri_Walter\\promptGenerator_5Levels.py", "--participant", participant, "--user", user], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
generate_prompts.wait()

### Run experiment and image generation scripts concurrently ###
generate_images = subprocess.Popen(["python", f"C:\\Users\{user}\\Dropbox\\Kerri_Walter\\imageGenerator_5Levels.py", "--participant", participant, "--user", user], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
run_experiment = subprocess.Popen(["python", f"C:\\Users\{user}\\Dropbox\\Kerri_Walter\\runExperiment_5Levels.py", "--participant", participant, "--user", user], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
